...
import { faAws, faDocker, faGit, faGithub, faGitlab, faMicrosoft } from "@fortawesome/free-brands-svg-icons";
        ...
        <>
            <div className = "container about-page"> 
                <div className = "text-zone"> 
                    ...
                    <br/>
                    <DevList />
                    <Link to="/about" className="flat-button-1">PROGRAMMING LANGUAGES</Link>
                    <br/>
                    <Link to="/about/tech" className="flat-button-2">FRAMEWORKS</Link>
                    </p>
                </div>
                <div className = "stage-cube-cont">
                    <div className = "cubespinner"> 
                        ...
                        <div className = "face3">
                            <FontAwesomeIcon icon={faGit} color="#28A4D9"/>
                        </div>
                        <div className = "face4">
                            <FontAwesomeIcon icon={faGithub} color="#5ED4F4"/>
                        </div>
                        <div className = "face5">
                            <FontAwesomeIcon icon={faGitlab} color="#ffd700"/>
                        </div>
                        <div className = "face6">
