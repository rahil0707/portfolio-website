...
import { faReact, faLinux, faNodeJs, faNode, faAngular, faSquareJs } from "@fortawesome/free-brands-svg-icons";
        ...
        <>
            <div className = "container about-page"> 
                <div className = "text-zone"> 
                    ...
                    <br/>
                    <TechList />
                    <Link to="/about" className="flat-button-5">PROGRAMMING LANGUAGES</Link>
                    <br/>
                    <br/>
                    <br/>
                    <Link to="/about/dev" className="flat-button-6">TOOLS</Link>
                    </p>
                </div>
                <div className = "stage-cube-cont">
                    <div className = "cubespinner"> 
                        ...
                        <div className = "face3">
                            <FontAwesomeIcon icon={faSquareJs} color="#28A4D9"/>
                        </div>
                        <div className = "face4">
